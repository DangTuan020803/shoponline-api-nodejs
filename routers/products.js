...
router.post(
  ...
  [
    check("tensanpham")
      .notEmpty()
      .withMessage("Ten san pham khong duoc phep de trong"),
    ...
    check("soluong")
      .notEmpty()
      .withMessage("So luong khong duoc phep de trong"),
    check("anhdaidien")
      .notEmpty()
      .withMessage("Anh dai dien khong duoc phep de trong"),
    check("danhmuc_id")
      .notEmpty()
      .withMessage("ID cua Danh muc khong duoc phep de trong"),
  ],
  (req, res, next) => {
